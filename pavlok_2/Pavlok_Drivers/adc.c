...
static nrf_saadc_channel_config_t s_channel2Config;
...
void adc_init(void)
{
  ...
  // Set configuration for saadc channel 0
	...
	s_channel2Config.resistor_p = NRF_SAADC_RESISTOR_DISABLED;
	s_channel2Config.resistor_n = NRF_SAADC_RESISTOR_DISABLED;
	s_channel2Config.gain       = NRF_SAADC_GAIN1_6;
	s_channel2Config.reference  = NRF_SAADC_REFERENCE_INTERNAL;
	s_channel2Config.acq_time   = NRF_SAADC_ACQTIME_20US;
	s_channel2Config.mode       = NRF_SAADC_MODE_SINGLE_ENDED;
	s_channel2Config.pin_p      = (nrf_saadc_input_t)(ADC_CHANNEL_USB_VOLTAGE);
	s_channel2Config.pin_n      = NRF_SAADC_INPUT_DISABLED;
	...
	APP_ERROR_CHECK( err_code );
	err_code = nrf_drv_saadc_channel_init(USB_VOLTAGE_CHAN, &s_channel2Config);
	APP_ERROR_CHECK( err_code );
}
